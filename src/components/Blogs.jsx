                    ...
                    >
                        ...
                        <div className="flex flex-wrap gap-3">
                            ...
                            <button
                                ...
                                className={`px-4 py-2 rounded-lg text-sm font-medium transition-all flex items-center gap-2 ${selectedCategory === "Featured"
                                    ? 'bg-gradient-to-r from-amber-500/20 to-orange-500/20 text-amber-400 border border-amber-500/50'
                                    : 'bg-slate-900/50 text-slate-400 border border-slate-800 hover:text-amber-400 hover:border-amber-500/30'
                                    }`}
                            >
                                <span>⭐ Featured</span>
                            ...
                            >
                                {paginatedBlogs.map((blog, index) => (
                                    <a
                                        ...
                                        className={`rounded-2xl overflow-hidden transition-all duration-300 group cursor-pointer flex flex-col h-full ${blog.featured
